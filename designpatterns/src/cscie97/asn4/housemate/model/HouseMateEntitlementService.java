...
public class HouseMateEntitlementService {
	...
	/**HMES is a singleton object. 
	 * 
	 * @return the instance of the HMES; if none exist, will retun a new instance
	 */
	...
	/**When an occupant gets created via the HMMS system, a corresponding user gets created here
	 * 
	 * @param occupantName the name of the occupant will also be the ID and this will pseudo generate a voiceprint for the user as well
	 */
